    ...
    var init_actions = function(){
        ...
        popupblock.on("click",options.submitformbutton,function(){
            ...
            if(form.length>0){
                ...
                if (form.attr("id") == "feedback_user_form_id") {

                	// [[CUSTOM]] case
                	/*var formSelector = $('#'+form.attr("id"))[0];
	                ...
	                formData2.append("username", "Groucho");
					formData2.append("accountnum", 123456); // number 123456 is immediately converted to a string "123456"
