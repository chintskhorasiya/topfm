<section id="container">
    ...
    <section id="main-content">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <section class="panel  border-o">
                            <header class="panel-heading btn-primary">Add Review</header>
        ...
        jQuery('.add-video-btn').click(function(){
            ...
            jQuery(this).before('<div class="col-md-12 you-video-area"><input type="text" name="data[Review][videos][]" class="form-control" value="" placeholder="Paste Video URL here" /><input type="button" class="remove-video-btn btn btn-info" value="Remove"></div>');
        })
        jQuery(function(){
