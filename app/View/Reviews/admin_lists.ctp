                ...
                <div class="col-lg-12">
                    ...
                    <section class="panel">
                        <div class="panel-body">
                            ...
                            <p>List of reviews created by you.</p>
                            <div class="adv-table">
                                <?php
                                echo $this->Html->link(
                                    'Add Review',
                                ...
                                echo $this->Form->create('reviewSearch', array('url' => array('controller' => 'reviews', 'action' => 'search')));
                                ...
                                echo $this->Form->create('reviewsList',array('url' => array('controller' => 'reviews', 'action' => 'delete_selected')));
                                ?>
                                <input type="submit" class="btn btn-info btn-delete" value="Delete Selected Review">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            <tr class="gradeA">
                                                ...
                                                <td>
                                                	<input type="checkbox" name="review_checks[]" value ="<?php echo $reviews[$i]['Review']['id']; ?>">
                                                </td>
                                                
                                                <td class="align-center">
                                                	<?php echo $reviews[$i]['Review']['created']?>
                                                </td>
                                                
                                                <td>
                                                    <div class="btn-group zn-listing-link">
                                                        <?php echo $reviews[$i]['Review']['title']; ?>
                                                    </div>
                                                </td>

                                                <td>
                                                	<?php
                                                    if($reviews[$i]['Review']['status']=='1'){
                                                        ?>
                                                ...
                                                <td> 
                                                    <a href="<?php echo DEFAULT_ADMINURL.'reviews/edit/reviewId:'.$reviews[$i]['Review']['id'];?>" class="btn btn-default">Edit</a>
                                                    |
                                                    <a href="<?php echo DEFAULT_ADMINURL.'reviews/delete/reviewId:'.$reviews[$i]['Review']['id'];?>" class="btn btn-default btn-delete">Delete</a>
                                                </td>
                                            </tr>
                                            <?php
                                            }
