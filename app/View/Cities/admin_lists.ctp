                ...
                <div class="col-lg-12">
                    ...
                    <section class="panel">
                        <div class="panel-body">
                            ...
                            <p>List of cities created by you.</p>

                            <?php
                            echo $this->Form->create('citiesSearch', array('url' => array('controller' => 'cities', 'action' => 'search')));
                            ...
                            <div class="adv-table">
                                ...
                                echo $this->Form->create('citiesList',array('url' => array('controller' => 'cities', 'action' => 'delete_selected')));
                                ?>
                                <input type="submit" class="btn btn-info btn-delete" value="Delete Selected Cities">
                                    ...
                                    <tbody>
                                        ...
                                        if(isset($cities) && count($cities)>0) 
                                        {
                                            ...
                                            <tr class="gradeA">
                                                ...
                                                <td>
                                                	<input type="checkbox" name="cities_checks[]" value ="<?php echo $cities[$i]['City']['id']; ?>">
                                                </td>
                                                
                                                <td class="align-center">
                                                	<?php echo $cities[$i]['City']['created']?>
                                                </td>
                                                
                                                <td>
                                                    <div class="btn-group zn-listing-link">
                                                        <?php echo $cities[$i]['City']['title']; ?>
                                                    </div>
                                                </td>

                                                <td>
                                                	<?php
                                                    if($cities[$i]['City']['status']=='1'){
                                                        ?>
                                                ...
                                                <td> 
                                                    <a href="<?php echo DEFAULT_ADMINURL.'cities/edit/cityId:'.$cities[$i]['City']['id'];?>" class="btn btn-default">Edit</a>
                                                    |
                                                    <a href="<?php echo DEFAULT_ADMINURL.'cities/delete/cityId:'.$cities[$i]['City']['id'];?>" class="btn btn-default btn-delete">Delete</a>
                                                </td>
                                            </tr>
                                            <?php
                                            }
                            ...
                            <?php echo $this->Paginator->next('Next »', array('class' => 'btn btn-default'), null,
                                array('class' => 'disabled')); ?> 
                            <!-- prints X of Y, where X is current page and Y is number of cities -->
