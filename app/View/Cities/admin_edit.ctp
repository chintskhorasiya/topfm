                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <section class="panel  border-o">
                            <header class="panel-heading btn-primary">Edit City</header>
                            <div class="panel-body">
                                <div class="position-center">
                                    <?php
                                    echo $this->Form->create('City', array('novalidate'));
                                    
                                    echo $this->Form->input('title', array('class' => 'form-control input-lg', 'value' => $city_data['City']['title']));

                                    echo $this->Form->input('slug', array('class' => 'form-control input-lg', 'value' => $city_data['City']['slug']));
                                    ...
                                    echo $this->Html->link('Cancel', DEFAULT_ADMINURL.'citys/lists', array('class' => 'btn btn-info'));
                                    ?>
                                    </div>
                                </div>
                            </div>
