                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <section class="panel  border-o">
                            <header class="panel-heading btn-primary">Add Program</header>
                            <div class="panel-body">
                                <div class="position-center">
                                    ...
                                    //var_dump($page_data['Program']['status']);exit;
                                    ...
                                    echo $this->Form->input('program_time', array('class' => 'form-control'));
                                    ?>
