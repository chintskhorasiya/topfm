                ...
                <div class="col-lg-12">
                    ...
                    <section class="panel">
                        <div class="panel-body">
                            ...
                            <p>List of rjs created by you.</p>
                            <div class="adv-table">
                                <?php
                                echo $this->Html->link(
                                    'Add Rj',
                                ...
                                if(isset($rjs) && count($rjs)>0) 
                                {
                                ?>

                                <?php
                                
                                echo $this->Form->create('rjSearch', array('url' => array('controller' => 'rjs', 'action' => 'search')));
                                ...
                                echo $this->Form->create('rjsList',array('url' => array('controller' => 'rjs', 'action' => 'delete_selected')));
                                ?>
                                <input type="submit" class="btn btn-info btn-delete" value="Delete Selected Rj">
                                ...
                                <table class="display table table-bordered table-striped" id="dynamic-table">
                                    ...
                                    <tbody>
                                        <?php
                                            for($i=0;$i<count($rjs);$i++)
                                            {
                                            ?>
                                            <tr class="gradeA">
                                                
                                                <td>
                                                	<input type="checkbox" name="rj_checks[]" value ="<?php echo $rjs[$i]['Rj']['id']; ?>">
                                                </td>
                                                
                                                <td class="align-center">
                                                	<?php echo $rjs[$i]['Rj']['created']?>
                                                </td>
                                                
                                                <td>
                                                    <div class="btn-group zn-listing-link">
                                                        <?php echo $rjs[$i]['Rj']['title']; ?>
                                                    </div>
                                                </td>

                                                <td>
                                                	<?php
                                                    if($rjs[$i]['Rj']['status']=='1'){
                                                        ?>
                                                ...
                                                <td> 
                                                    <a href="<?php echo DEFAULT_ADMINURL.'rjs/edit/rjId:'.$rjs[$i]['Rj']['id'];?>" class="btn btn-default">Edit</a>
                                                    |
                                                    <a href="<?php echo DEFAULT_ADMINURL.'rjs/delete/rjId:'.$rjs[$i]['Rj']['id'];?>" class="btn btn-default btn-delete">Delete</a>
                                                </td>
                                            </tr>
                                            <?php
                                            }
