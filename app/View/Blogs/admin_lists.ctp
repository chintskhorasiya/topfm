                ...
                <div class="col-lg-12">
                    ...
                    <section class="panel">
                        <div class="panel-body">
                            ...
                            <p>List of blogs created by you.</p>
                            <div class="adv-table">
                                <?php
                                echo $this->Html->link(
                                    'Add Blog',
                                ...
                                echo $this->Form->create('blogSearch', array('url' => array('controller' => 'blogs', 'action' => 'search')));
                                ...
                                echo $this->Form->create('blogsList',array('url' => array('controller' => 'blogs', 'action' => 'delete_selected')));
                                ?>
                                <input type="submit" class="btn btn-info btn-delete" value="Delete Selected Blog">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            <tr class="gradeA">
                                                ...
                                                <td>
                                                	<input type="checkbox" name="blog_checks[]" value ="<?php echo $blogs[$i]['Blog']['id']; ?>">
                                                </td>
                                                
                                                <td class="align-center">
                                                	<?php echo $blogs[$i]['Blog']['created']?>
                                                </td>
                                                
                                                <td>
                                                    <div class="btn-group zn-listing-link">
                                                        <?php echo $blogs[$i]['Blog']['title']; ?>
                                                    </div>
                                                </td>

                                                <td>
                                                	<?php
                                                    if($blogs[$i]['Blog']['status']=='1'){
                                                        ?>
                                                ...
                                                <td> 
                                                    <a href="<?php echo DEFAULT_ADMINURL.'blogs/edit/blogId:'.$blogs[$i]['Blog']['id'];?>" class="btn btn-default">Edit</a>
                                                    |
                                                    <a href="<?php echo DEFAULT_ADMINURL.'blogs/delete/blogId:'.$blogs[$i]['Blog']['id'];?>" class="btn btn-default btn-delete">Delete</a>
                                                </td>
                                            </tr>
                                            <?php
                                            }
