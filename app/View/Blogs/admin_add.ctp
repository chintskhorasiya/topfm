<section id="container">
    ...
    <section id="main-content">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <section class="panel  border-o">
                            <header class="panel-heading btn-primary">Add Blog</header>
                            <div class="panel-body">
                                <div class="position-center">
                                    ...
                                    echo $this->Form->input('short_content', array('type' => 'textarea', 'class' => 'form-control input-lg'));
        ...
        jQuery('.add-video-btn').click(function(){
            ...
            jQuery(this).before('<div class="col-md-12 you-video-area"><input type="text" name="data[Blog][videos][]" class="form-control" value="" placeholder="Paste Video URL here" /><input type="button" class="remove-video-btn btn btn-info" value="Remove"></div>');
        })
        jQuery(function(){
