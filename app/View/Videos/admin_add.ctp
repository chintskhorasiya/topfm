                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <section class="panel  border-o">
                            <header class="panel-heading btn-primary">Add Video</header>
                                ...
                                <div class="position-center">
                                    ...
                                    <div class="form-group col-md-12 padding-left-o">
                                        ...
                                        <div class="col-md-12 you-video-area">
                                            <input type="text" name="data[Video][video]" class="form-control" value="" placeholder="Paste Video URL here" />
