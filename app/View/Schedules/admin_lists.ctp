                ...
                <div class="col-lg-12">
                    ...
                    <section class="panel">
                        <div class="panel-body">
                            ...
                            <p>List of schedules created by you.</p>
                            <div class="adv-table">
                                <?php
                                echo $this->Html->link(
                                    'Add Schedule',
                                ...
                                echo $this->Form->create('scheduleSearch', array('url' => array('controller' => 'schedules', 'action' => 'search')));
                                ...
                                echo $this->Form->create('schedulesList',array('url' => array('controller' => 'schedules', 'action' => 'delete_selected')));
                                ?>
                                <input type="submit" class="btn btn-info btn-delete" value="Delete Selected Schedule">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            <tr class="gradeA">
                                                ...
                                                <td>
                                                	<input type="checkbox" name="schedule_checks[]" value ="<?php echo $schedules[$i]['Schedule']['id']; ?>">
                                                </td>
                                                
                                                <td class="align-center">
                                                	<?php echo $schedules[$i]['Schedule']['created']?>
                                                </td>
                                                
                                                <td>
                                                    <div class="btn-group zn-listing-link">
                                                        <?php echo $schedules[$i]['Schedule']['title']; ?>
                                                    </div>
                                                </td>

                                                <td>
                                                	<?php
                                                    if($schedules[$i]['Schedule']['status']=='1'){
                                                        ?>
                                                ...
                                                <td> 
                                                    <a href="<?php echo DEFAULT_ADMINURL.'schedules/edit/scheduleId:'.$schedules[$i]['Schedule']['id'];?>" class="btn btn-default">Edit</a>
                                                    |
                                                    <a href="<?php echo DEFAULT_ADMINURL.'schedules/delete/scheduleId:'.$schedules[$i]['Schedule']['id'];?>" class="btn btn-default btn-delete">Delete</a>
                                                </td>
                                            </tr>
                                            <?php
                                            }
