                ...
                <div class="col-lg-12">
                    ...
                    <section class="panel">
                        <div class="panel-body">
                            ...
                            <p>List of events created by you.</p>
                            <div class="adv-table">
                                <?php
                                echo $this->Html->link(
                                    'Add Event',
                                ...
                                echo $this->Form->create('eventSearch', array('url' => array('controller' => 'events', 'action' => 'search')));
                                ...
                                echo $this->Form->create('eventsList',array('url' => array('controller' => 'events', 'action' => 'delete_selected')));
                                ?>
                                <input type="submit" class="btn btn-info btn-delete" value="Delete Selected Event">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            <tr class="gradeA">
                                                ...
                                                <td>
                                                	<input type="checkbox" name="event_checks[]" value ="<?php echo $events[$i]['Event']['id']; ?>">
                                                </td>
                                                
                                                <td class="align-center">
                                                	<?php echo $events[$i]['Event']['created']?>
                                                </td>
                                                
                                                <td>
                                                    <div class="btn-group zn-listing-link">
                                                        <?php echo $events[$i]['Event']['title']; ?>
                                                    </div>
                                                </td>

                                                <td>
                                                	<?php
                                                    if($events[$i]['Event']['status']=='1'){
                                                        ?>
                                                ...
                                                <td> 
                                                    <a href="<?php echo DEFAULT_ADMINURL.'events/edit/eventId:'.$events[$i]['Event']['id'];?>" class="btn btn-default">Edit</a>
                                                    |
                                                    <a href="<?php echo DEFAULT_ADMINURL.'events/delete/eventId:'.$events[$i]['Event']['id'];?>" class="btn btn-default btn-delete">Delete</a>
                                                </td>
                                            </tr>
                                            <?php
                                            }
